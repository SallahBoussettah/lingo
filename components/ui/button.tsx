  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-primary text-primary-foreground hover:bg-primary/90 border-primary-depth border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-primary hover:bg-slate-100",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/90 border-secondary-depth border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-secondary hover:bg-slate-100",
        danger: "bg-destructive text-destructive-foreground hover:bg-destructive/90 border-destructive-depth border-b-4 active:border-b-0",
        dangerOutline: "bg-white text-destructive hover:bg-slate-100",
        super: "bg-super text-super-foreground hover:bg-super/90 border-super-depth border-b-4 active:border-b-0",
        superOutline: "bg-white text-super hover:bg-slate-100",
